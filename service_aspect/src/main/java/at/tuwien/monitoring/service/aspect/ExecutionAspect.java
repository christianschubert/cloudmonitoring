...
public class ExecutionAspect {
	...
	// jmsService = new JmsSenderService(Constants.brokerURL,
	// GlobalConstants.QUEUE_CLIENTS);
	// jmsService.start();
	...
	// public Object annotationRequest(final ProceedingJoinPoint
	...
	// sendReponseTime(monitorRequest.target(), monitorRequest.method(),
	...
	// }
	//
	// sendReponseTime(httpURLConnection.getURL().toString(),
	// Method.valueOf(httpURLConnection.getRequestMethod()),
	// responseTime, responseCode);
	// }
	//
	// return response;
	// }
	//
	// public void sendReponseTime(final String target, final Method method,
	// final long responseTime,
	// final int responseCode) {
	// if (jmsService.isConnected()) {
	// MetricAggregationMessage metricAggregationMessage = new
	// MetricAggregationMessage();
	// metricAggregationMessage.addMetricMessage(new
	// ClientResponseTimeMessage(publicIPAddress, new Date(), target,
