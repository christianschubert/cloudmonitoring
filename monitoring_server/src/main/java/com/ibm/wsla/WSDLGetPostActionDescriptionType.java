...
/**
 * <p>Java-Klasse für WSDLGetPostActionDescriptionType complex type.
 * 
 * <p>Das folgende Schemafragment gibt den erwarteten Content an, der in dieser Klasse enthalten ist.
 * 
 * <pre>
 * &lt;complexType name="WSDLGetPostActionDescriptionType"&gt;
 *   &lt;complexContent&gt;
...
@XmlType(name = "WSDLGetPostActionDescriptionType", propOrder = {
    "serviceName",
    "address"
})
public class WSDLGetPostActionDescriptionType
